...
- 裁罰率：私立 52%、非營利 28%、公立 8%
- **列層 vs 事件層（2026-09-12 eng review 實查修正）**：1,474 列 = 1,004 個園×日期事件（同案多法條分列，3 列完全重複）。回頭客（≥2 事件）234/487 = **48%**（列層 62%）；回頭客貢獻 751/1,004 = **75%**（列層 88%）；事件後 12 個月再犯 33%，排除 30 天內同案 **26%**（列層 35%）。**deck 一律用事件層數字。**
- 連坐（同負責人他園 12 個月內被罰）11% vs 基準 7%（列層，待事件層重算）
